...
const ArticleFeedback = ({ article, resumeUrl, onBack, onFeedbackSent }: ArticleFeedbackProps) => {
  ...
  // Update editedArticle when article prop changes (e.g., after feedback submission)
  useEffect(() => {
    console.log('ArticleFeedback: Article prop changed, updating editedArticle:', article);
    setEditedArticle(article);
    // Clear feedback when new article content arrives
    setFeedback('');
  }, [article]);
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-lg">Ihr generierter Artikel</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4 mb-6">
            <Label htmlFor="article">Generierter Artikel (bearbeitbar)</Label>
            <Textarea
              ref={textareaRef}
              id="article"
              value={editedArticle}
              ...
              placeholder="Hier kannst du den Artikel bearbeiten..."
            />
          </div>
          ...
          <form onSubmit={handleSubmitFeedback} className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Gib hier dein Feedback zum Artikel ein. Was gefällt dir? Was sollte geändert werden?"
                rows={4}
